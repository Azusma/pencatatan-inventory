@extends('layouts.app', ['page' => __('Pengaturan Pengguna'), 'pageSlug' => 'pengguna', 'section' => 'pengguna'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('users.create') }}" class="btn btn-sm btn-primary">{{ __('Tambah Pengguna') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
