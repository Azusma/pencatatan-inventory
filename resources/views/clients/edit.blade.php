@extends('layouts.app', ['page' => 'Edit Pelanggan', 'pageSlug' => 'Pelanggan', 'section' => 'pelanggan'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Pengaturan Pelanggan') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('clients.index') }}" class="btn btn-sm btn-primary">{{ __('Kembali ke Daftar') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('clients.update', $client) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Informasi Pelanggan') }}</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-1">
                                        <label class="form-control-label" for="input-document_type">{{ __('Tipe') }}</label>
                                    ...
                                    <div class="col">
                                        <label class="form-control-label" for="input-document_id">{{ __('Nomor Dokumen') }}</label>
