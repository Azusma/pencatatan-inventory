@extends('layouts.app', ['page' => 'Daftar Produk', 'pageSlug' => 'produk', 'section' => 'Persediaan'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('products.create') }}" class="btn btn-sm btn-primary">Tambah Produk Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
