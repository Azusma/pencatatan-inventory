                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="<?php echo e(route('transactions.create', ['type' => 'income'])); ?>" class="btn btn-sm btn-primary">Buat Pendapatan Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', ['page' => 'Pendapatan', 'pageSlug' => 'Pendapatan', 'section' => 'transaksi'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Dokumen\New folder (3)\laravel-inventory\resources\views/transactions/income/index.blade.php ENDPATH**/ ?>