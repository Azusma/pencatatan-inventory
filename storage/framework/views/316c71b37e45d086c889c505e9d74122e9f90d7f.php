                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-sm btn-primary">Tambah Produk Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', ['page' => 'Daftar Produk', 'pageSlug' => 'produk', 'section' => 'Persediaan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Dokumen\New folder (3)\laravel-inventory\resources\views/inventory/products/index.blade.php ENDPATH**/ ?>