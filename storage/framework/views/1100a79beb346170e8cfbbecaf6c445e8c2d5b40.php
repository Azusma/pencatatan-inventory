                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('transactions.type', ['type' => 'expense'])); ?>" class="btn btn-sm btn-primary">Kembali ke Daftar</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['page' => 'Tambah Beban Baru', 'pageSlug' => 'Beban', 'section' => 'Transaksi'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Dokumen\New folder (3)\laravel-inventory\resources\views/transactions/expense/create.blade.php ENDPATH**/ ?>