                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="<?php echo e(route('methods.create')); ?>" class="btn btn-sm btn-primary">Tambah Metode Pembayaran Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="">
                        <table class="table tablesorter " id="">
                            <thead class=" text-primary">
                                ...
                                <th scope="col">Total Transaksi Bulanan</th>
                                <th scope="col"></th>
                            </thead>
                            <tbody>
...
<?php echo $__env->make('layouts.app', ['page' => 'Metoden Pembayaran', 'pageSlug' => 'methods', 'section' => 'Metode'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Dokumen\New folder (3)\laravel-inventory\resources\views/methods/index.blade.php ENDPATH**/ ?>