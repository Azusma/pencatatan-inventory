        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <form method="post" action="<?php echo e(route('profile.password')); ?>" autocomplete="off">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-primary">Ganti Password</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', ['page' => __('Profil Pengguna'), 'pageSlug' => 'profil', 'section' => 'pengguna'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Dokumen\New folder (3)\laravel-inventory\resources\views/profile/edit.blade.php ENDPATH**/ ?>